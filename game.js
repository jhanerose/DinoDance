            ...
            this.fruitsArr.forEach(
                (fruit, index) => {
                    ...
                    if (fruit.playerID === 2 && fruit.y > 650) {
                        ...
                        this.p2streak = 0;
                        this.p2score = Math.max(0, this.p2score - 10); // Deduct 10 points but don't go below 0
                        this.player2.stopAnimation(); // Stop dancing when missing fruit
                    }
                    if (fruit.playerID === 1 && fruit.y > 650) {
                        // this.fruitsArr.splice(index, 1);
                        this.fruitsArr = this.fruitsArr.filter(element => element != fruit);
                        this.p1streak = 0;
                        this.p1score = Math.max(0, this.p1score - 10); // Deduct 10 points but don't go below 0
                        this.player1.stopAnimation(); // Stop dancing when missing fruit
                    }
                }
            )
        } /* else { this.fruitsArr = [] } */
                ...
                if (fruit.playerID === 1) {
                    if (keyIsDown(81) && fruit.type === 'banana') {
                        if (fruit.y >= 590 && fruit.y <= 613) {
                            ...
                            this.p1streak++;
                            this.player1.resumeAnimation(); // Resume dancing when hitting fruit
                ...
                // PLAYER 2's key presses for fruit
                    ...
                    if (keyIsDown(85) && fruit.type === 'banana') {
                        if (fruit.y > 590 && fruit.y < 613) {
                            ...
                            this.p2streak++;
                            this.player2.resumeAnimation(); // Resume dancing when hitting fruit
                            // this.fruitsArr.splice(index, 1) // Removes fruit if hit, regardless of hit level
                            this.fruitsArr = this.fruitsArr.filter(element => element != fruit);
                        }
                    }
